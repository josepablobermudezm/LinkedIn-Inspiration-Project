        ...
        <div class="sidebar-wrapper">
            ...
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    <li class="email"><svg class="svg-inline--fa fa-envelope fa-w-16" aria-hidden="true"
                        ...
                        </svg><!-- <i class="fas fa-envelope"></i> Font Awesome fontawesome.com --><a
                            href="mailto: yourname@email.com">alan.doe@website.com</a></li>
                    <li class="phone"><svg class="svg-inline--fa fa-phone fa-w-16" aria-hidden="true" focusable="false"
                        ...
                        </svg><!-- <i class="fas fa-phone"></i> Font Awesome fontawesome.com --><a
                            href="tel:0123 456 789">0123 456 789</a></li>
                    <li class="website"><svg class="svg-inline--fa fa-globe fa-w-16" aria-hidden="true"
                        ...
                        </svg><!-- <i class="fas fa-globe"></i> Font Awesome fontawesome.com --><a
                    ...
                    <li class="linkedin"><svg class="svg-inline--fa fa-linkedin-in fa-w-14" aria-hidden="true"
                        ...
                        </svg><!-- <i class="fab fa-linkedin-in"></i> Font Awesome fontawesome.com --><a href="#"
                            target="_blank">linkedin.com/in/alandoe</a></li>
                    <li class="github"><svg class="svg-inline--fa fa-github fa-w-16" aria-hidden="true"
                        ...
                        </svg><!-- <i class="fab fa-github"></i> Font Awesome fontawesome.com --><a href="#"
                            target="_blank">github.com/username</a></li>
                    <li class="twitter"><svg class="svg-inline--fa fa-twitter fa-w-16" aria-hidden="true"
