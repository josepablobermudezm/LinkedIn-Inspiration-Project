                    ...
                    <div id='div_media'>
                        <nav>
                            <ul id='menu'>
                                ...
                                @endif
                                <a href="{{ url('/agenda') }}"><button id="Button3" class="Button1" onclick="CambiarColor(this)"><i class="fas fa-id-card-alt"></i><br><label style="font-size: 20px; cursor: pointer;">Calendario</label></button></a>
