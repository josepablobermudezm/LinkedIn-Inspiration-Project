        ...
        <div id='div_media'>
            <nav>
                <ul id='menu'>
                    ...
                    <a href="{{ route('pdf') }}"><button id="Button3" class="Button1" onclick="CambiarColor(this)"><i class="fas fa-scroll"></i><br><label style="font-size: 20px; cursor: pointer;">Curriculum</label></button></a>
                </ul>
            </nav>
        </div>
    </div>
